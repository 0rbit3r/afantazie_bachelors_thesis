...
\def\Abstract{
This work is about design and implementation of a website called Aphantasia - an Obsidian inspired social network
which allows users to create posts, link them to others and most importantly view them as a part of an ever expanding interactive graph.
This strategy presents an alternative to user-post interaction on social networks
and should challengethe infinite feed approach as the standard of viewing content online.
We created a fully functional prototype of the application and compared it to other graph-rendering software.
Particular attention was payed to handling large amount of posts without sacrificing performance, readability and user experience.
}
